  ...
  <Layout>
    ...
    <Section.Container id="privacy" Background={Background}>
      <Box width={[320, 400, 600]} m="auto">
        ...
        <p>
          Juka ("us", "we", or "our") operates the https://jukalang.com website
          (the "Service").
        </p>
        <p>
          ...
          Juka is created with the help of the{' '}
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://jukalang.com
        </p>
        ...
        <h2>Use of Data</h2>
        <p>Juka uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Juka will take all steps reasonably necessary to ensure that your data
        ...
        <p>
          Juka may disclose your Personal Data in the good faith belief that
        ...
        <ul>
          <li>
            ...
            <a
              ...
              data-cfemail="a0c1c4cdc9cee0cad5cbc1ccc1cec78ec3cfcd"
            >
              [email&#160;protected]
            </a>
          </li>
          <li>
            By visiting this page on our website: https://jukalang.com/contact
          </li>
        </ul>
      </Box>
    </Section.Container>
